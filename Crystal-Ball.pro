...
UBUNTU_TRANSLATION_DOMAIN="crystal-ball.arc676"
...
aptest.commands = bash $$PWD/Crystal-Ball/tests/autopilot/run
aptest.depends  = sub-Crystal-Ball

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Crystal-Ball/tests/unit 
unittest.depends  = sub-Crystal-Ball
